...
public interface IfServiceRestApi {
    ...
    @Operation(summary = "Get all If services properties", description = "Get all If services properties", tags = {"If services"})
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Successful operation",
                    content = @Content),
    ...
    @Produces({MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML})
    @Operation(summary = "Get the If services properties specified by the given ID", description = "Get the If services properties specified by the given ID", tags = {"If services"})
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Successful operation",
                    content = @Content),
    ...
    @Operation(summary = "Create many If services", description = "Create many If services", tags = {"If services"})
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Successful operation",
                    content = @Content),
