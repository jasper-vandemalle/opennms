...
public interface EventRestApi {
    ...
    @Operation(summary = "Get all events properties", description = "Get all events properties", tags = {"Events"})
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Successful operation",
                    content = @Content),
    ...
    @Produces({MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML})
    @Operation(summary = "Get the events properties specified by the given ID", description = "Get the events properties specified by the given ID", tags = {"Events"})
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Successful operation",
                    content = @Content),
    ...
    @Operation(summary = "Publish a event", description = "Publish a event")
    @ApiResponses(value = {
