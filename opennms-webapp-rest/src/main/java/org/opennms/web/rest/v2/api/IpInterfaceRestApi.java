...
public interface IpInterfaceRestApi  {
    ...
    @Path("{id}")
    @Produces({MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML, MediaType.APPLICATION_ATOM_XML})
    @Operation(summary = "Get the IP interfaces specified by the given ID", description = "Get the IP interfaces specified by the given ID", tags = {"IP interfaces"})
    @ApiResponses(value = {
    ...
    @Operation(summary = "Get all IP interfaces properties", description = "Get all IP interfaces properties", tags = {"IP interfaces"})
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Successful operation",
                    content = @Content),
    ...
    @Produces({MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML})
    @Operation(summary = "Get the IP interfaces properties specified by the given ID", description = "Get the IP interfaces properties specified by the given ID", tags = {"IP interfaces"})
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Successful operation",
                    content = @Content),
