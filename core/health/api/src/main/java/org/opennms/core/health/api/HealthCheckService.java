...
public interface HealthCheckService {
     ...
     * @param listener gets informed about health check progress. May be null.
     ...
     */
    Either<String, CompletableFuture<Health>> performAsyncHealthCheck(Context context, ProgressListener listener, List<String> tags);
